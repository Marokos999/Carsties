...
{
    public static void InitiDbForTests(AuctionDbContext db)
    {
        db.Auctions.AddRange(GetAucxtionForTest());
        db.SaveChanges();
    }

    public static void RecreateDbForTests(AuctionDbContext db)
    {
    ...
    private static List<Auction> GetAucxtionForTest()
    {
